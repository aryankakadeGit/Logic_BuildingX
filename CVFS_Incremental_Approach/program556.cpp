...
// Description :   Used to Write the data into the file .
// Input :         File Descriptor , 
//                 Address of Buffer having data , 
//                 Size of data to be Written
// Output :        Returns NO OF BYTES SUCCESSFULLY WRITTEN
// Author :        Aryan Hanumant Kakade
// Date :          22/01/2026
///////////////////////////////////////////////////////////////////////////////////////
int WriteFile(
              ...
              )
{
    ...
    {
        return ERR_INSUFFIECIENT_SPACE;
    }
...
// Description :   Used to Read the data from the file .
// Input :         File Descriptor , 
//                 Address of Empty Buffer to store data , 
//                 Size of data to be Read
// Output :        Returns NO OF BYTES SUCCESSFULLY READ
// Author :        Aryan Hanumant Kakade
// Date :          22/01/2026
///////////////////////////////////////////////////////////////////////////////////////
int ReadFile(
              ...
              )
{
    ...
    //THERE IS NO PERMISSION TO READ
...
int main()
{
    char * EmptyBuffer=NULL; //BUFFER TO READ 
    char str[80]={'\0'};
    char InputBuffer[MAX_FILE_SIZE]={'\0'}; //BUFFER TO WRITE
    char command[5][20]={'\0'};
    int iCount = 0;
    int iRet = 0;
    ...
    while(1)
    {
        ...
        else if(iCount==2)
        {
            ...
            else if(strcmp("write",command[0])==0)
            {
                    ...
                    else if(iRet==ERR_INSUFFIECIENT_SPACE)
                    {
                        printf("ERROR : CANNOT WRITE FURTHER AS THERE IS NO SPACE\n");
                    }
                    else
                    {
        ...
        else if(iCount==3)
        {
            ...
            if(strcmp("read",command[0])==0)
            {
                ...
                if(iRet==ERR_INVALID_PARAMETER)
                    ...
                    else if(iRet==ERR_INSUFFIECIENT_DATA)
                    {
                        printf("ERROR : CANNOT READ FURTHER AS THERE IS NO SPACE\n");
                    }
                    else
                    {
                        printf("READ successfully DONE\n");
